    ...
    try {
       ...
       WHERE slug = ? AND is_active = 1`,
        ...
        const [detail] = await db.query(
            `SELECT * FROM general_service_details
       WHERE service_id = ? AND is_active = 1`,
            [service.id]
        );

        const [sections] = await db.query(
            `SELECT * FROM general_service_sections
       WHERE service_id = ?
       ORDER BY sort_order ASC`,
        ...
        const [pointsRaw] = await db.query(
            `SELECT * FROM general_service_points
       WHERE service_id = ?
       ORDER BY sort_order ASC`,
            [service.id]
        );
        ...
        const [products] = await db.query(
            `SELECT * FROM general_service_products
       WHERE service_id = ? AND is_active = 1
       ORDER BY sort_order ASC`,
            [service.id]
        );
...
exports.saveDetail = async (req, res) => {
    try {
        ...
        const image = req.file
            ? `/uploads/service-details/${req.file.filename}`
            : null;

        const [existing] = await db.query(
            `SELECT * FROM general_service_details WHERE service_id = ?`,
            [service_id]
        );
        ...
        if (existing.length) {
            ...
            await db.query(
                `UPDATE general_service_details
         ...
         WHERE service_id=?`,
            ...
            await db.query(
                `INSERT INTO general_service_details
...
exports.createSection = async (req, res) => {
    try {
        ...
        await db.query(
            `INSERT INTO general_service_sections
...
exports.updateSection = async (req, res) => {
    try {
        ...
        await db.query(
            `UPDATE general_service_sections
...
exports.deleteSection = async (req, res) => {
    try {
        ...
        await db.query(
            `DELETE FROM general_service_sections WHERE id=?`,
            [id]
        );
...
exports.createPoint = async (req, res) => {
    try {
        ...
        await db.query(
            `INSERT INTO general_service_points
...
exports.deletePoint = async (req, res) => {
    try {
        ...
        await db.query(
            `DELETE FROM general_service_points WHERE id=?`,
            [id]
        );
...
exports.createProduct = async (req, res) => {
    try {
        ...
        await db.query(
            `INSERT INTO general_service_products
...
exports.updateProduct = async (req, res) => {
    try {
        ...
        const [rows] = await db.query(
            `SELECT * FROM general_service_products WHERE id=?`,
            [id]
        );
        ...
        if (req.file) {
            ...
            image = `/uploads/service-details/${req.file.filename}`;
        }

        await db.query(
            `UPDATE general_service_products
...
exports.deleteProduct = async (req, res) => {
    try {
        ...
        const [rows] = await db.query(
            `SELECT image FROM general_service_products WHERE id=?`,
            [id]
        );
        ...
        await db.query(
            `DELETE FROM general_service_products WHERE id=?`,
            [id]
        );
